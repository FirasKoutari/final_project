...
def save_employee(request):
    ...
    if len(check) > 0:
        ...
        try:
            ...
            # Customize the error handling according to your needs
            # For example, you can return an error response or redirect the user to an error page
...
def update_performance(request):
    # Logic to update the performance table
    # ...
